...
local ClosureBindings = {
	...
	[55] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(55)return {
		...
		Dialog = Color3.fromRGB(0, 130, 0),
		DialogHolder = Color3.fromRGB(0, 130, 0),
		DialogHolderLine = Color3.fromRGB(0, 130, 0),
		DialogButton = Color3.fromRGB(0, 130, 0),
		DialogButtonBorder = Color3.fromRGB(0, 130, 0),
		DialogBorder = Color3.fromRGB(0, 130, 0),
		DialogInput = Color3.fromRGB(0, 130, 0),
		DialogInputLine = Color3.fromRGB(0, 130, 0),
