...
function Slider:SetValue(Value)
	...
	[55] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(55)return {
		...
		Dialog = Color3.fromRGB(146, 255, 146),
		DialogHolder = Color3.fromRGB(146, 255, 146),
		DialogHolderLine = Color3.fromRGB(146, 255, 146),
		DialogButton = Color3.fromRGB(146, 255, 146),
		DialogButtonBorder = Color3.fromRGB(146, 255, 146),
		DialogBorder = Color3.fromRGB(146, 255, 146),
		DialogInput = Color3.fromRGB(146, 255, 146),
		DialogInputLine = Color3.fromRGB(175, 160, 190),
